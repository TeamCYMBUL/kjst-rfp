    ...
    exportComparisonXlsx(
      {
        ...
        stay2_arrival_date: (trip as any).stay2_arrival_date ?? null,
        stay2_departure_date: (trip as any).stay2_departure_date ?? null,
        stay2_game_date: (trip as any).stay2_game_date ?? null,
