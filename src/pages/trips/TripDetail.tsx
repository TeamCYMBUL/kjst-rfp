                  ...
                  exportSingleHotelXlsx(
                    {
                      ...
                      stay2_king_rate: (response as any).stay2_king_rate ?? null,
                      stay2_suite_rate: (response as any).stay2_suite_rate ?? null,
                      stay2_selling_rate: (response as any).stay2_selling_rate ?? null,
                      occupancy_tax: response.occupancy_tax,
                      resort_fee: (response as any).resort_fee ?? null,
                      meeting_space_notes: response.meeting_space_notes,
                      general_comments: response.general_comments,
                      menu_attachments: (response as any).menu_attachments ?? null,
