...
Deno.serve(async (req: Request) => {
  ...
  if (body?.test) {
    ...
    const slack = await notifySlack(`Test alert — KJST monitoring is wired to this channel. Outage, server-error, and health alerts will land here. Sent ${fmt(new Date())}. No action needed.`, { emoji: '✅' })
